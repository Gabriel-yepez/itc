export default function AboutUs() {
  return (
    <section className="w-full py-16 sm:py-24 border-t border-neutral" id="quienes-somos">
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <h2 className="font-headline text-3xl font-bold tracking-tight text-black sm:text-4xl lg:text-5xl mb-6">
            Ingeniería de Software con Propósito y Precisión
          </h2>
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 border-t border-neutral pt-8">
            <div>
              <div className="font-headline text-3xl font-black text-primary">10+</div>
              <div className="font-label text-xs font-semibold uppercase text-black mt-1">Años de Experiencia</div>
            </div>
            <div>
              <div className="font-headline text-3xl font-black text-secondary">100%</div>
              <div className="font-label text-xs font-semibold uppercase text-black mt-1">Compromiso con la Calidad</div>
            </div>
          </div>
        </div>
